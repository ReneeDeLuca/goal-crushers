...
const Hero = () => {
  ...
  return (
    <>
      {!userInfo ? (
        <FormContainer className="flex min-h-full flex-1 flex-col mx-auto justify-center px-6 py-6">
          <div className="flex min-h-full flex-1 flex-col justify-center px-6 pb-6">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              <>
                <section className="mx-auto w-full max-w-sm my-4 inline-flex items-center justify-center">
                  <Link to="/login" className="sm:block">
                    <button
                      type="button"
                  ...
                  <Link to="/register" className="ml-3 sm:block">
                    <button
                      type="button"
